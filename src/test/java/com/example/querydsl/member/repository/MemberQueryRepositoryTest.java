...
class MemberQueryRepositoryTest {
    ...
    public void basicTest(){
        ...
        Member findMember = memberQueryRepository.findById(member.getMemberId()).get();
        assertThat(findMember).isEqualTo(member);

        List<Member> result1 = memberQueryRepository.findAll_Querydsl();
        assertThat(result1).containsExactly(member);

        List<Member> result2 = memberQueryRepository.findByUsername_Querydsl(member.getUsername());
